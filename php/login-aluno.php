...
if ($api->isLoggedIn() && $api->getTipoLogado() === 'aluno') {
    header('Location: portal-aluno/vagas.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email) || empty($senha)) {
        ...
        $result = $api->login('aluno', $email, $senha);
...
<head>
    ...
    <title>Login do Aluno — Portal UniALFA</title>
...
<div class="container" style="max-width:440px">
    ...
    <div class="card">
        <h2 style="margin-bottom:20px;text-align:center">Login do Aluno</h2>
        ...
        <p style="text-align:center;margin-top:16px;font-size:14px">
            Não tem conta? <a href="cadastro-aluno.php" style="color:var(--azul-medio)">Cadastre-se</a>
        </p>
        <p style="text-align:center;margin-top:8px;font-size:13px">
            <a href="login-empresa.php" style="color:var(--texto-suave)">Sou uma empresa →</a>
        </p>
    </div>
